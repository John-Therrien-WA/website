...
from the originals above (not hand-edited). Pages are mapped to a card by `ref`
in `_data/og_images.yml`; `_includes/meta.html` emits the tags. Rerun the script
after changing a source or the card list.

| Card (assets/images/) | Source original | Style |
| --- | --- | --- |
| `og-default.jpg` | `band-photo-home.jpg` | photo cover-crop (site-wide fallback; home, contact, musings essays) |
| `og-about.jpg` | `band-photo-01.jpg` | photo cover-crop |
| `og-live.jpg` | `band-photo-07.jpg` | photo cover-crop |
| `og-lyrics.jpg` | `lyrics-wallpaper.jpg` | photo cover-crop |
| `og-musings.jpg` | `musings-wallpaper.jpg` | photo cover-crop |
| `og-album-2025.jpg` | `album-cover-2025.jpg` | album composite (music, Self-Titled 2025, lyrics/child) |
| `og-album-2024.jpg` | `album-cover-2024.png` | album composite (Magisches Theater + its lyrics) |
| `og-album-2020.jpg` | `album-cover-2020.jpg` | album composite (lyrics/acoustic) |
